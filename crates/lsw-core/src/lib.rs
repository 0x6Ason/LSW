...
pub use agent_protocol::{
    ...
    GuiWindowClosed, GuiWindowDamage, GuiWindowReady, GuiWindowResize, LiveShareConfigureRequest,
    ...
    WindowsSudoStatus, AGENT_PROTOCOL_VERSION, CAPABILITY_CONPTY_V1,
    CAPABILITY_DESKTOP_COMPANION_V1, CAPABILITY_DESKTOP_LIVE_SHARE_V1, CAPABILITY_DETACHED_RUN_V1,
    CAPABILITY_GUI_ICON_V1, CAPABILITY_GUI_LAUNCH_V1, CAPABILITY_GUI_WINDOW_V1,
